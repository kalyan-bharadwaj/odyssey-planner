...
/**
 * Normalises every Nest exception to ODYSSEY's legacy error envelope so migrated
 ...
 */
@Catch()
export class OdysseyExceptionFilter implements ExceptionFilter {
    ...
    if (exception instanceof HttpException) {
      ...
      if (body && typeof body === 'object') {
        ...
        // ODYSSEY-native shape ({ error } / { error, code } from guards + the Zod
