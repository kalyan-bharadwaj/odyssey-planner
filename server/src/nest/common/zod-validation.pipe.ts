...
/**
 * Validates an incoming @Body()/@Query() against a Zod schema (from @odyssey/shared)
 * and returns the parsed, typed value. On failure it throws ODYSSEY's error envelope
