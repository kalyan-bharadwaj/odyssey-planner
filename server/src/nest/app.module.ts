...
import { OdysseyExceptionFilter } from './common/odyssey-exception.filter';
...
@Module({
  ...
  providers: [
    ...
    { provide: APP_FILTER, useClass: OdysseyExceptionFilter },
    ...
    // is more specific than OdysseyExceptionFilter, so Nest routes 404s here.
