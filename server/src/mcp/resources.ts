...
export function registerResources(server: McpServer, userId: number, scopes: string[] | null): void {
  ...
  if (canReadTrips(scopes))
    server.registerResource(
      'trip',
      new ResourceTemplate('odyssey://trips/{tripId}', { list: undefined }),
  ...
  if (canReadTrips(scopes))
    server.registerResource(
      'trip-days',
      new ResourceTemplate('odyssey://trips/{tripId}/days', { list: undefined }),
  ...
  if (canRead(scopes, 'places'))
    server.registerResource(
      'trip-places',
      new ResourceTemplate('odyssey://trips/{tripId}/places', { list: undefined }),
      {
        description:
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget'))
    server.registerResource(
      'trip-budget',
      new ResourceTemplate('odyssey://trips/{tripId}/budget', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'packing'))
    server.registerResource(
      'trip-packing',
      new ResourceTemplate('odyssey://trips/{tripId}/packing', { list: undefined }),
  ...
  if (canRead(scopes, 'reservations'))
    server.registerResource(
      'trip-reservations',
      new ResourceTemplate('odyssey://trips/{tripId}/reservations', { list: undefined }),
  ...
  if (canReadTrips(scopes))
    server.registerResource(
      'day-notes',
      new ResourceTemplate('odyssey://trips/{tripId}/days/{dayId}/notes', { list: undefined }),
  ...
  if (canReadTrips(scopes))
    server.registerResource(
      'trip-accommodations',
      new ResourceTemplate('odyssey://trips/{tripId}/accommodations', { list: undefined }),
      {
  ...
  if (canReadTrips(scopes))
    server.registerResource(
      'trip-members',
      new ResourceTemplate('odyssey://trips/{tripId}/members', { list: undefined }),
  ...
  if (collabFeatures?.notes && canRead(scopes, 'collab'))
    server.registerResource(
      'trip-collab-notes',
      new ResourceTemplate('odyssey://trips/{tripId}/collab-notes', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'todos'))
    server.registerResource(
      'trip-todos',
      new ResourceTemplate('odyssey://trips/{tripId}/todos', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget'))
    server.registerResource(
      ...
      new ResourceTemplate('odyssey://trips/{tripId}/budget/per-person', { list: undefined }),
      {
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget'))
    server.registerResource(
      ...
      new ResourceTemplate('odyssey://trips/{tripId}/budget/settlement', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'packing'))
    server.registerResource(
      'trip-packing-bags',
      new ResourceTemplate('odyssey://trips/{tripId}/packing/bags', { list: undefined }),
  ...
  if (collabFeatures?.polls && canRead(scopes, 'collab')) {
    server.registerResource(
      'trip-collab-polls',
      new ResourceTemplate('odyssey://trips/{tripId}/collab/polls', { list: undefined }),
  ...
  if (collabFeatures?.chat && canRead(scopes, 'collab')) {
    server.registerResource(
      ...
      new ResourceTemplate('odyssey://trips/{tripId}/collab/messages', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.VACAY) && canRead(scopes, 'vacay')) {
    ...
    server.registerResource(
      'vacay-entries',
      new ResourceTemplate('odyssey://vacay/entries/{year}', { list: undefined }),
    ...
    server.registerResource(
      'vacay-holidays',
      new ResourceTemplate('odyssey://vacay/holidays/{year}', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.JOURNEY) && canRead(scopes, 'journey')) {
    ...
    server.registerResource(
      'journey-detail',
      new ResourceTemplate('odyssey://journeys/{journeyId}', { list: undefined }),
    ...
    server.registerResource(
      'journey-entries',
      new ResourceTemplate('odyssey://journeys/{journeyId}/entries', { list: undefined }),
    ...
    server.registerResource(
      ...
      new ResourceTemplate('odyssey://journeys/{journeyId}/contributors', { list: undefined }),
