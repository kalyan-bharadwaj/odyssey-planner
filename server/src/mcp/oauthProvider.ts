...
export const odysseyClientsStore: OAuthRegisteredClientsStore = {
...
export const odysseyOAuthProvider: OAuthServerProvider = {
  get clientsStore() {
    return odysseyClientsStore;
  },
  ...
  async authorize(client: OAuthClientInformationFull, params: AuthorizationParams, res: Response): Promise<void> {
    ...
    if (resource !== mcpResource) {
      ...
      url.searchParams.set('error_description', 'Requested resource must be the ODYSSEY MCP endpoint');
