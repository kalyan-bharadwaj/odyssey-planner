...
const DUMMY_PASSWORD_HASH = bcrypt.hashSync('__odyssey_no_such_user__', BCRYPT_COST);
...
export function setupMfa(
  ...
  try {
    ...
    otpauth_url = authenticator.keyuri(userEmail, 'ODYSSEY', secret);
  } catch (err) {
...
export function createMcpToken(
  ...
  const rawToken = 'odyssey_' + randomBytes(24).toString('hex');
