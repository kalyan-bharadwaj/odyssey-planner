...
const UA = 'ODYSSEY Travel Planner (https://github.com/mauriceboe/ODYSSEY)';

// ODYSSEY's internal language codes mostly coincide with valid BCP-47 codes, but a
...
export async function resolveGoogleMapsUrl(
  ...
  const nominatimRes = await fetch(
    ...
    { headers: { 'User-Agent': 'ODYSSEY-Travel-Planner/1.0' }, signal: AbortSignal.timeout(8000) },
  );
