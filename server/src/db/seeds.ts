...
function seedAdminAccount(db: Database.Database): void {
  try {
    ...
    // Demo mode seeds its own admin (admin@odyssey.app, username 'admin') right after this.
    ...
    if (isOidcOnlyConfigured()) {
      console.log('');
      console.log('╔══════════════════════════════════════════════╗');
      console.log('║  ODYSSEY — OIDC-Only Mode                       ║');
    ...
    console.log('');
    console.log('╔══════════════════════════════════════════════╗');
    console.log('║  ODYSSEY — First Run: Admin Account Created     ║');
    console.log('╠══════════════════════════════════════════════╣');
  ...
  try {
    const defaultAddons = [
      ...
      },
      {
        id: 'airtrail',
        name: 'AirTrail',
        description: 'Sync flights from your self-hosted AirTrail instance',
        type: 'integration',
        icon: 'Plane',
        enabled: 0,
        sort_order: 14,
