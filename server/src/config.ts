import { SUPPORTED_LANGUAGE_CODES as SUPPORTED_LANG_CODES } from '@odyssey/shared';
...
// SESSION_DURATION controls how long a ODYSSEY session (the `odyssey_session` JWT
...
// persistent `odyssey_session` cookie `maxAge`. An unticked login keeps
