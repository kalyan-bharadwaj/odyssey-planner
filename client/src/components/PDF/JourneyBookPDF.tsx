...
import { sanitizeRichTextHtml } from '@odyssey/shared';
...
<body>
  ...
  <div class="cover-page">
    ...
    <div class="cover-footer">Made with ODYSSEY</div>
  </div>
  ...
  <div class="closing-page">
    <div>
      ...
      <div class="closing-sub">Made with ODYSSEY · ${new Date().getFullYear()}</div>
    </div>
  </div>
