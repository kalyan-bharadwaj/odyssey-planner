    ...
    <div className="rounded-xl border border-edge bg-surface-card p-3">
      ...
      {showInvite &&
        ReactDOM.createPortal(
          <div
            className="odyssey-backdrop-enter fixed inset-0 flex items-center justify-center bg-[rgba(15,23,42,0.5)] px-4"
            style={{ zIndex: 99990, paddingTop: 70 }}
            onClick={() => setShowInvite(false)}
          >
            <div
              className="odyssey-modal-enter w-full max-w-sm rounded-2xl bg-surface-card shadow-2xl"
      ...
      {showColorPicker &&
        ReactDOM.createPortal(
          ...
          >
            <div
              className="odyssey-modal-enter w-full max-w-xs rounded-2xl bg-surface-card shadow-2xl"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between border-b border-edge-secondary p-5">
