...
export default function Modal({
  ...
  return ReactDOM.createPortal(
    <div
      className="odyssey-modal-backdrop odyssey-backdrop-enter fixed inset-0 z-[200] flex items-start justify-center bg-[rgba(15,23,42,0.5)] px-4 sm:items-center"
    ...
    >
      <div
        className={`odyssey-modal-enter w-full overflow-hidden rounded-2xl shadow-2xl ${sizeClasses[size] || sizeClasses.md} flex max-h-[calc(100dvh-var(--bottom-nav-h)-90px)] flex-col bg-surface-card sm:max-h-[calc(100dvh-90px)]`}
