        ...
        ReactDOM.createPortal(
          <div
            ...
            style={{
              ...
              overflow: 'hidden',
              animation: 'odyssey-menu-enter 200ms cubic-bezier(0.23, 1, 0.32, 1)',
          ...
          >
            ...
            <div style={{ maxHeight: 220, overflowY: 'auto', padding: '4px' }}>
              {filtered.length === 0 ? (
                <div style={{ padding: '10px 12px', fontSize: 12, color: 'var(--text-faint)', textAlign: 'center' }}>
                  —
                </div>
              ) : (
                filtered.map((option) => {
