...
const SUPPORTER_TIERS: SupporterTier[] = [
  {
    id: 'no_return_ticket',
    labelKey: 'settings.about.supporter.tier.noReturnTicket',
    price: '∞',
    gradient: 'linear-gradient(135deg, #fbbf24, #ec4899 55%, #6366f1)',
    glow: 'rgba(236,72,153,0.45)',
    icon: InfinityIcon,
  },
  {
    id: 'lost_luggage_vip',
    labelKey: 'settings.about.supporter.tier.lostLuggageVip',
    price: '$30',
  ...
  {
    id: 'business_class_dreamer',
    labelKey: 'settings.about.supporter.tier.businessClassDreamer',
    price: '$15',
  ...
  {
    id: 'budget_traveller',
    labelKey: 'settings.about.supporter.tier.budgetTraveller',
    price: '$10',
  ...
  {
    id: 'hostel_bunkmate',
    labelKey: 'settings.about.supporter.tier.hostelBunkmate',
    price: '$5',
...
const SUPPORTERS: Supporter[] = [{ username: 'Someone', tier: 'hostel_bunkmate', since: '2026-04' }];
          ...
          {SUPPORTER_TIERS.map((tier) => {
            ...
            return (
              <div key={tier.id} className="supporter-tier" style={{ opacity: empty ? 0.55 : 1 }}>
                <div
                  className="supporter-tier-icon"
                  style={{ background: tier.gradient, boxShadow: `0 6px 18px ${tier.glow}` }}
                >
                ...
                <div className="supporter-tier-body">
                  ...
                  <div className="supporter-tier-chips">
                    {empty && <span className="supporter-tier-empty">{t('settings.about.supporters.tierEmpty')}</span>}
                    {members.map((m) => {
                      const chipContent = (
                        <>
                      ...
                      return m.link ? (
                        ...
                        <div key={m.username} className="supporter-chip">
                          {chipContent}
                        </div>
                      );
                    })}
  ...
  return (
    <Section title={t('settings.about')} icon={Info}>
      ...
      <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
        <a
          href="https://github.com/mauriceboe/ODYSSEY/issues/new?template=bug_report.yml"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-4 overflow-hidden rounded-xl border border-edge bg-surface-card px-5 py-4 no-underline transition-[border-color,box-shadow] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)]"
          onMouseEnter={(e) => {
        ...
        <a
          href="https://github.com/mauriceboe/ODYSSEY/discussions/new?category=feature-requests"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-4 overflow-hidden rounded-xl border border-edge bg-surface-card px-5 py-4 no-underline transition-[border-color,box-shadow] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)]"
          onMouseEnter={(e) => {
        ...
        <a
          href="https://github.com/mauriceboe/ODYSSEY/wiki"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-4 overflow-hidden rounded-xl border border-edge bg-surface-card px-5 py-4 no-underline transition-[border-color,box-shadow] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)]"
          onMouseEnter={(e) => {
