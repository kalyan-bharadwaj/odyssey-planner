...
export const RESERVATION_SOURCE_ID = 'odyssey-reservations'
export const RESERVATION_LINE_LAYER_ID = 'odyssey-reservations-lines'
  ...
  private updateStatsRotation = () => {
    ...
    for (const entry of this.statsMarkers) {
      ...
      try {
        ...
        const inner = el.querySelector('.odyssey-stats-inner') as HTMLElement | null
