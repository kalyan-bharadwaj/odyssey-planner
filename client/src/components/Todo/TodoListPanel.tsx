    ...
    <div style={{ display: 'flex', height: 'calc(100vh - 180px)', minHeight: 400 }}>
      ...
      <div
        style={{
          ...
          padding: isMobile ? '12px 6px' : '16px 12px 16px 0',
          display: 'flex',
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: sortByPrio ? 600 : 400,
            transition: 'all 0.1s',
          }}
          onMouseEnter={(e) => {
            if (!sortByPrio) e.currentTarget.style.background = 'var(--bg-hover)';
          }}
          onMouseLeave={(e) => {
            if (!sortByPrio) e.currentTarget.style.background = 'transparent';
          }}
        >
      ...
      {isAddingNew &&
        ...
        ReactDOM.createPortal(
          <div
            ...
            className="odyssey-modal-backdrop"
            style={{
              position: 'fixed',
              inset: 0,
              zIndex: 1000,
          ...
          {addingCategory ? (
            <div style={{ display: 'flex', gap: 4 }}>
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter') setAddingCategoryInline(false);
                  if (e.key === 'Escape') {
                    setCategory('');
              ...
              <button
                type="button"
                onClick={() => setAddingCategoryInline(false)}
                style={{
                  background: 'var(--bg-hover)',
                  border: '1px solid var(--border-primary)',
                  borderRadius: 8,
                  ...
                  options={[
                      ...
                      icon: (
                        <span
                          style={{
                            ...
                            height: 8,
                            borderRadius: '50%',
                            background: katColor(c, categories),
                    ...
                    ...(category && !categories.includes(category)
                      ? [
                          {
                            value: category,
                            label: `${category} (${t('todo.newCategoryLabel') || 'new'})`,
                            icon: (
                              <span
                                style={{
                                  width: 8,
          ...
          <CustomSelect
            ...
            options={[
              ...
              ...members.map((m) => ({
                ...
                icon: m.avatar ? (
                  <img
                    src={`/uploads/avatars/${m.avatar}`}
                    style={{ width: 18, height: 18, borderRadius: '50%', objectFit: 'cover' as const }}
                    alt=""
                  />
                ) : (
                  <span
        ...
        <div style={{ padding: '12px 20px', borderTop: '1px solid var(--border-faint)', display: 'flex', gap: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              fontFamily: 'inherit',
              border: 'none',
              background: hasChanges ? 'var(--text-primary)' : 'var(--border-faint)',
      ...
      <div style={{ padding: '12px 20px', borderTop: '1px solid var(--border-faint)' }}>
        <button
          ...
          style={{
            ...
            fontFamily: 'inherit',
            border: 'none',
            background: name.trim() ? 'var(--text-primary)' : 'var(--border-faint)',
            color: name.trim() ? 'var(--bg-primary)' : 'var(--text-faint)',
            transition: 'all 0.15s',
          }}
        >
