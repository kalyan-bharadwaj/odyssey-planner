...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur ODYSSEY Demo',
    description:
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the ODYSSEY Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de ODYSSEY',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من ODYSSEY',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo ODYSSEY',
    description:
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          >
            {t.titleBefore}
            <img src="/text-dark.svg" alt="ODYSSEY" style={{ height: 18 }} />
            {t.titleAfter}
          </h2>
        </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#9ca3af' }}>
            ...
            <a
              href="https://github.com/mauriceboe/ODYSSEY"
              target="_blank"
