...
describe('DemoBanner', () => {
  ...
  it('shows "What is ODYSSEY?" section', () => {
    render(<DemoBanner />);
    expect(screen.getByText('What is ODYSSEY?')).toBeInTheDocument();
  });
  ...
  it('self-host link points to GitHub', () => {
    ...
    expect(link).toHaveAttribute('href', 'https://github.com/mauriceboe/ODYSSEY');
