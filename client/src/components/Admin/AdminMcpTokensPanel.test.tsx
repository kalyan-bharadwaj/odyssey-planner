...
describe('AdminMcpTokensPanel', () => {
  ...
  it('FE-ADMIN-MCP-003: token list renders correctly', async () => {
    ...
    expect(screen.getByText(/odyssey_abc/)).toBeInTheDocument();
    expect(screen.getByText(/odyssey_xyz/)).toBeInTheDocument();
  });
