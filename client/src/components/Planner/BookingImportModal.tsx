import type { BookingImportPreviewItem } from '@odyssey/shared';
import { Anchor, ArrowLeft, Calendar, Car, Hotel, Plane, Train, Upload, UtensilsCrossed, X } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: 'auto', minHeight: 0 }}>
          ...
          {phase === 'upload' && (
            <>
              ...
              >
                ...
                />
                {isDragOver ? (
                  <span className="text-accent" style={{ pointerEvents: 'none' }}>
                    {t('reservations.import.dropActive')}
                  </span>
                ) : files.length > 0 ? (
                  <span
                    style={{
                  ...
                  <span style={{ color: 'var(--text-faint)', textAlign: 'center', pointerEvents: 'none' }}>
                    {t('reservations.import.dropHere')}
                  </span>
                )}
              </div>
            </>
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      {item._accommodation?.check_in && (
                        <div style={{ fontSize: 11, color: 'var(--text-faint)' }}>
                          {formatDateTime(item._accommodation.check_in)} –{' '}
                          {formatDateTime(item._accommodation.check_out)}
                        </div>
                      )}
          ...
          {warnings.length > 0 && (
            <div
              className="bg-[rgba(245,158,11,0.08)] text-[#92400e]"
              style={{
        ...
        >
          ...
          {phase === 'upload' && (
            <button
              ...
              className={
                files.length > 0 && !loading ? 'bg-accent text-accent-text' : 'bg-surface-tertiary text-content-faint'
              }
              style={{
                padding: '8px 16px',
                borderRadius: 10,
          ...
          {(phase === 'preview' || phase === 'confirming') && (
            <button
              ...
              className={
                activeCount > 0 && phase !== 'confirming'
              ...
              style={{
                ...
                fontSize: 13,
                fontWeight: 500,
                cursor: activeCount > 0 && phase !== 'confirming' ? 'pointer' : 'default',
                fontFamily: 'inherit',
              }}
            >
