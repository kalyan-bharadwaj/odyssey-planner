...
describe('DayPlanSidebar', () => {
  ...
  it('FE-PLANNER-DAYPLAN-005: renders multiple days', () => {
    const days = [buildDay({ title: 'D1', date: '2025-06-01' }), buildDay({ title: 'D2', date: '2025-06-02' })];
  ...
  it('FE-PLANNER-DAYPLAN-011: assigned place name rendered in day card', () => {
    ...
    const assignment = buildAssignment({ id: 99, day_id: 10, order_index: 0, place });
    render(
      <DayPlanSidebar {...makeDefaultProps({ days: [day], places: [place], assignments: { '10': [assignment] } })} />
    );
  ...
  it('FE-PLANNER-DAYPLAN-013: clicking a place calls onPlaceClick', async () => {
    ...
    render(
      <DayPlanSidebar
        {...makeDefaultProps({ days: [day], places: [place], assignments: { '10': [assignment] }, onPlaceClick })}
      />
    );
  ...
  it('FE-PLANNER-DAYPLAN-020: context menu Remove calls onRemoveAssignment', async () => {
    ...
    render(
      <DayPlanSidebar
        {...makeDefaultProps({ days: [day], places: [place], assignments: { '10': [assignment] }, onRemoveAssignment })}
      />
    );
  ...
  it('FE-PLANNER-DAYPLAN-051: clicking flight transport calls onEditTransport with reservation', async () => {
    ...
    render(
      <DayPlanSidebar {...makeDefaultProps({ days: [day], reservations: [reservation as any], onEditTransport })} />
    );
  ...
  it('FE-PLANNER-DAYPLAN-089: dropping place from sidebar onto expanded content area calls onAssignToDay', () => {
    ...
    const expandedArea =
      document.querySelector('[style*="padding-top: 6"]') || document.querySelector('[style*="paddingTop: 6"]');
    ...
    render(
      <DayPlanSidebar
        {...makeDefaultProps({
          ...
          assignments: assigns,
          selectedDayId: null,
          showRouteToolsWhenExpanded: true,
        })}
      />
    );
