import type { AirtrailFlight, AirtrailImportResult } from '@odyssey/shared';
      ...
      >
        ...
        <span style={{ flex: 1, minWidth: 0 }}>
          ...
          <span style={{ display: 'block', fontSize: 11, color: 'var(--text-muted)' }}>
            {f.fromCode ?? f.fromName ?? '?'} → {f.toCode ?? f.toName ?? '?'}
            {f.date ? ` · ${fmtDate(f.date, locale)}` : ''}
          </span>
        </span>
        {already && (
            ...
            <>
              <div
                style={{
                  ...
                  margin: `${during.length > 0 ? 14 : 2}px 0 8px`,
                }}
              >
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontSize: 13,
              fontWeight: 500,
              cursor: selectableCount > 0 && !importing ? 'pointer' : 'default',
              fontFamily: 'inherit',
            }}
          >
