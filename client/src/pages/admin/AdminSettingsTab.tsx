        ...
        <div className="space-y-5 p-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="odyssey.example.org"
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://odyssey.example.org"
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-transparent focus:ring-2 focus:ring-slate-400"
            />
          </div>
          <button
        ...
        <div className="space-y-4 p-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://auth.example.com/application/o/odyssey/.well-known/openid-configuration"
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-transparent focus:ring-2 focus:ring-slate-400"
            />
