        ...
        >
          ...
          >
            ...
            <div style={{ padding: '20px 24px' }}>
              ...
              >
                {`docker pull mauriceboe/odyssey:latest
docker stop odyssey && docker rm odyssey
docker run -d --name odyssey \\
  -p 3000:3000 \\
  -v /opt/odyssey/data:/app/data \\
  -v /opt/odyssey/uploads:/app/uploads \\
