    ...
    return (
      ...
      >
        <div style={{ textAlign: 'center', padding: 40 }}>
          ...
          <h1 className="text-[#111827]" style={{ fontSize: 20, fontWeight: 700 }}>
            {t('shared.expired')}
          </h1>
  ...
  return (
    <div className="bg-surface-secondary" style={{ minHeight: '100vh', fontFamily: 'var(--font-system)' }}>
      ...
      >
        ...
        >
          <img src="/icons/icon-white.svg" alt="ODYSSEY" width="26" height="26" />
        </div>
        ...
        {trip.description && (
          <div style={{ fontSize: 13, opacity: 0.5, maxWidth: 400, margin: '0 auto', lineHeight: 1.5 }}>
            {trip.description}
          </div>
        )}
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '20px 16px' }}>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        <div className="text-[#111827]" style={{ fontSize: 14, fontWeight: 600 }}>
                          {day.title || `Day ${day.day_number}`}
                        </div>
                        {day.date && (
                          <div className="text-[#9ca3af]" style={{ fontSize: 11, marginTop: 1 }}>
                        ...
                        {merged.map((item: any) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                  <div className="text-[#111827]" style={{ fontSize: 12, fontWeight: 500 }}>
                                    {r.title}
                                    {time ? ` · ${time}${endTime ? `–${endTime}` : ''}` : ''}
                                  </div>
                                  {sub && (
                                    <div className="text-[#6b7280]" style={{ fontSize: 10 }}>
                                      {sub}
                                    </div>
                                  )}
                                </div>
                          ...
                          if (item.type === 'note') {
                            return (
                              ...
                              >
                                ...
                                <div>
                                  <div className="text-[#374151]" style={{ fontSize: 12 }}>
                                    {item.data.text}
                                  </div>
                                  {item.data.time && (
                                    <div className="text-[#9ca3af]" style={{ fontSize: 10 }}>
                                      {item.data.time}
                                    </div>
                                  )}
                                </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div style={{ flex: 1, minWidth: 0 }}>
                                <div className="text-[#111827]" style={{ fontSize: 12.5, fontWeight: 500 }}>
                                  {place.name}
                                </div>
            ...
            {(reservations || []).map((r: any) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div className="text-[#111827]" style={{ fontSize: 13, fontWeight: 600 }}>
                      {r.title}
                    </div>
                    <div
                      className="text-[#9ca3af]"
                      style={{ fontSize: 11, display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 2 }}
                    >
                      {date && <span>{date}</span>}
                      {time && <span>{time}</span>}
                ...
                {items.map((item: any) => (
                  ...
                  >
                    <span
                      ...
                      style={{ fontSize: 13, textDecoration: item.checked ? 'line-through' : 'none' }}
                    >
                      {item.name}
                    </span>
                  </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                {Object.entries(grouped).map(([cat, items]: [string, any]) => (
                  ...
                  >
                    ...
                    >
                      <span className="text-[#374151]" style={{ fontSize: 12, fontWeight: 700 }}>
                        {cat}
                      </span>
                      <span className="text-[#6b7280]" style={{ fontSize: 12, fontWeight: 600 }}>
                        {items
                          .reduce((s: number, i: any) => s + (parseFloat(i.total_price) || 0), 0)
                    ...
                    {items.map((item: any) => (
                      ...
                      >
                        <span className="text-[#111827]" style={{ fontSize: 13 }}>
                          {item.name}
                        </span>
                        <span className="text-[#111827]" style={{ fontSize: 13, fontWeight: 600 }}>
                          {item.total_price
                            ? Number(item.total_price).toLocaleString(locale, { minimumFractionDigits: 2 })
                            : '—'}
                        </span>
                      </div>
                    ))}
                ...
                return (
                  <div key={msg.id}>
                    {showDate && (
                      <div
                        className="text-[#9ca3af]"
                        style={{ textAlign: 'center', margin: '8px 0', fontSize: 10, fontWeight: 600 }}
                      >
                    ...
                    <div style={{ display: 'flex', gap: 10 }}>
                      ...
                      >
                        {msg.avatar ? (
                          <img
                            src={`/uploads/avatars/${msg.avatar}`}
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                          <span className="text-[#111827]" style={{ fontSize: 12, fontWeight: 600 }}>
                            {msg.username}
                          </span>
                        ...
                        <div
                          className="text-[#374151]"
                          style={{ fontSize: 13, marginTop: 3, lineHeight: 1.5, whiteSpace: 'pre-wrap' }}
                        >
                          {msg.text}
                        </div>
                      </div>
        ...
        <div style={{ textAlign: 'center', padding: '40px 0 20px' }}>
          ...
          >
            <img src="/icons/icon.svg" alt="ODYSSEY" width="18" height="18" style={{ borderRadius: 4 }} />
            <span className="text-[#9ca3af]" style={{ fontSize: 11 }}>
              {t('shared.sharedVia')} <strong className="text-[#6b7280]">ODYSSEY</strong>
            </span>
          </div>
          <div className="text-[#d1d5db]" style={{ marginTop: 8, fontSize: 10 }}>
            Made with <span className="text-[#ef4444]">&hearts;</span> by Maurice ·{' '}
            <a href="https://github.com/mauriceboe/ODYSSEY" className="text-[#9ca3af]" style={{ textDecoration: 'none' }}>
              GitHub
            </a>
          </div>
        </div>
