  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      >
        ...
        <h1 className="relative" style={{ margin: '0 0 4px', fontSize: 26, fontWeight: 700, letterSpacing: -0.5 }}>
          {journey.title}
        </h1>
        ...
        {journey.subtitle && (
          <div
            className="relative"
            style={{ fontSize: 13, opacity: 0.5, maxWidth: 400, margin: '0 auto', lineHeight: 1.5 }}
          >
            {journey.subtitle}
          </div>
        )}
        ...
        >
          <span style={{ fontSize: 12, fontWeight: 500, opacity: 0.8, display: 'flex', alignItems: 'center', gap: 5 }}>
      ...
      <div className="flex flex-col items-center gap-2 py-8">
        ...
        >
          ...
          <span style={{ fontSize: 11, color: '#9ca3af' }}>
            {t('journey.public.sharedVia')} <strong style={{ color: '#6b7280' }}>ODYSSEY</strong>
          </span>
        </div>
        <div style={{ fontSize: 10, color: '#d1d5db' }}>
          Made with <span style={{ color: '#ef4444' }}>♥</span> by Maurice ·{' '}
          <a href="https://github.com/mauriceboe/ODYSSEY" style={{ color: '#9ca3af', textDecoration: 'none' }}>
            GitHub
          </a>
        </div>
      </div>
