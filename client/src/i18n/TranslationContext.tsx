import type { SupportedLanguageCode } from '@odyssey/shared';
import {
  SUPPORTED_LANGUAGES,
  escapeHtml,
  getIntlLanguage,
...
const localeLoaders: Record<SupportedLanguageCode, () => Promise<{ default: TranslationStrings }>> = {
  ...
  de: () => import('@odyssey/shared/i18n/de'),
  es: () => import('@odyssey/shared/i18n/es'),
  fr: () => import('@odyssey/shared/i18n/fr'),
  hu: () => import('@odyssey/shared/i18n/hu'),
  it: () => import('@odyssey/shared/i18n/it'),
  tr: () => import('@odyssey/shared/i18n/tr'),
  ru: () => import('@odyssey/shared/i18n/ru'),
  zh: () => import('@odyssey/shared/i18n/zh'),
  'zh-TW': () => import('@odyssey/shared/i18n/zh-TW'),
  nl: () => import('@odyssey/shared/i18n/nl'),
  id: () => import('@odyssey/shared/i18n/id'),
  ar: () => import('@odyssey/shared/i18n/ar'),
  br: () => import('@odyssey/shared/i18n/br'),
  cs: () => import('@odyssey/shared/i18n/cs'),
  pl: () => import('@odyssey/shared/i18n/pl'),
  ja: () => import('@odyssey/shared/i18n/ja'),
  ko: () => import('@odyssey/shared/i18n/ko'),
  uk: () => import('@odyssey/shared/i18n/uk'),
  gr: () => import('@odyssey/shared/i18n/gr'),
};
