...
export const airtrailSettingsSchema = z.object({
  /** Instance origin, e.g. https://flights.example.com — ODYSSEY appends /api itself. */
  ...
  /**
   * Opt in to writing ODYSSEY edits back to AirTrail (#1240). Off by default:
   * AirTrail is the source of truth and ODYSSEY only reads from it.
   */
