...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'ODYSSEYの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がODYSSEYの未来を支えています。',
  ...
  'settings.about.description': 'ODYSSEYはセルフホスト型の旅行プランナーです。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、ODYSSEY は読み取りのみを行います。ODYSSEY で行った編集を AirTrail に書き戻すにはオンにします。',
