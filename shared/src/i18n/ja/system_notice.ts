...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_photos.body':
    '旅行プランナー内の写真は削除されましたが、写真データは安全です。ODYSSEYがImmichやSynologyのライブラリを変更することはありません。\n\n写真は現在日記アドオンにあります。日記は任意機能です。未有効の場合は、管理画面 → アドオンで有効にしてください。',
  ...
  'system_notice.v3_mcp.body':
    'MCP連携が全面的に刷新されました。OAuth 2.1が推奨認証方式です。従来の静的トークン（odyssey_…）は非推奨となり、将来削除されます。',
  'system_notice.v3_mcp.highlight_oauth': 'OAuth 2.1推奨（mcp-remote）',
  'system_notice.v3_mcp.highlight_scopes': '24の詳細な権限スコープ',
  'system_notice.v3_mcp.highlight_deprecated': '静的odyssey_トークンは非推奨',
  'system_notice.v3_mcp.highlight_tools': 'ツールとプロンプトを拡張',
  'system_notice.v3_thankyou.title': '開発者より一言',
  'system_notice.v3_thankyou.body':
    '少しだけお時間をください。\n\nODYSSEYは、自分の旅のために作った小さな個人プロジェクトでした。それが今では4,000人以上に使ってもらえるとは思ってもいませんでした。スターも、Issueも、機能要望も、すべて目を通しています。\n\nODYSSEYはこれからもオープンソース、自分でホストでき、あなたのものです。トラッキングなし、サブスクなし。旅が好きな人が作ったツールです。\n\nhttps://github.com/jubnlにも感謝を。3.0の多くはあなたのおかげです。\n\nバグ報告、翻訳、共有、利用してくれたすべての方へ—本当にありがとうございます。\n\nこれからも一緒に旅を。\n\n— Maurice',
