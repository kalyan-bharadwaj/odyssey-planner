...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en ODYSSEY.',
  ...
  'admin.weather.description':
    'ODYSSEY utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando ODYSSEY',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'ODYSSEY {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText':
    'ODYSSEY se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText':
    'Tu instancia de ODYSSEY se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  ...
  'admin.passkey.rpIdHint':
    'El dominio puro al que se vinculan las passkeys, p. ej. odyssey.example.org. Déjalo vacío para derivarlo de APP_URL. Cambiarlo más adelante invalida las passkeys existentes.',
  'admin.passkey.origins': 'Orígenes permitidos',
  'admin.passkey.originsHint':
    'Orígenes completos separados por comas, p. ej. https://odyssey.example.org. Déjalo vacío para usar APP_URL.',
