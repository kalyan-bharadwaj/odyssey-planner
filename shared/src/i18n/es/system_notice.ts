...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bienvenido a ODYSSEY',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de ODYSSEY',
  ...
  'system_notice.v3_mcp.body':
    'La integración MCP ha sido completamente renovada. OAuth 2.1 es ahora el método de autenticación recomendado. Los tokens estáticos (odyssey_…) están obsoletos y se eliminarán en una versión futura.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estáticos odyssey_ obsoletos',
