...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no ODYSSEY.',
  ...
  'admin.weather.description':
    'O ODYSSEY usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o ODYSSEY',
  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O ODYSSEY {version} está disponível. Você está na {current}.',
  ...
  'admin.update.confirmText':
    'O ODYSSEY será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância ODYSSEY roda no Docker. Para atualizar para {version}, execute no servidor:',
  ...
  'admin.passkey.rpIdHint':
    'O domínio puro ao qual as passkeys ficam vinculadas, ex.: odyssey.example.org. Deixe vazio para derivá-lo de APP_URL. Alterá-lo depois invalida as passkeys existentes.',
  'admin.passkey.origins': 'Origens permitidas',
  'admin.passkey.originsHint':
    'Origens completas separadas por vírgula, ex.: https://odyssey.example.org. Deixe vazio para usar APP_URL.',
