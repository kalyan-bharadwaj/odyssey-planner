...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do ODYSSEY',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário ODYSSEY',
  ...
  'vacay.inviteHint': 'Convide outro usuário ODYSSEY para compartilhar um calendário de férias combinado.',
