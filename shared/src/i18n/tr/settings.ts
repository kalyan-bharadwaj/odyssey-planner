...
const settings: TranslationStrings = {
  ...
  'settings.ntfyUrl.topicPlaceholder': 'benim-odyssey-uyarilari',
  ...
  'settings.about.supporters.title': 'ODYSSEY için seyahat Arkadaşları',
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan ODYSSEY's future. Their monthly contribution goes straight into development and real hours spent — so ODYSSEY stays Open Source.",
  ...
  'settings.about.description':
    'ODYSSEY, seyahatlerinizi ilk fikirden son anıya kadar organize etmenize yardımcı olan, kendi kendine barındırılan bir seyahat planlayıcıdır. Gün planlaması, bütçe, paketleme listeleri, fotoğraflar ve çok daha fazlası; hepsi tek bir yerde, kendi sunucunuzda.',
  ...
  'settings.airtrail.writeBackHint':
    'Varsayılan olarak kapalı: AirTrail asıl kaynaktır ve ODYSSEY yalnızca okur. ODYSSEY’te yapılan değişiklikleri AirTrail’e geri göndermek için açın.',
