...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer ODYSSEY kullanıcılarıyla paylaşın',
  'vacay.owner': 'Mal sahibi',
  'vacay.shareEmailPlaceholder': 'ODYSSEY kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir ODYSSEY kullanıcısını birleşik bir tatil takvimini paylaşmaya davet edin.',
