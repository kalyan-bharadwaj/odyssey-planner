...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'ODYSSEY deneyiminizi özelleştirmek için özellikleri etkinleştirin veya devre dışı bırakın.',
  ...
  'admin.weather.description':
    "ODYSSEY, hava durumu veri kaynağı olarak Open-Meteo'yu kullanıyor. Open-Meteo ücretsiz, açık kaynaklı bir hava durumu hizmetidir; API anahtarı gerekmez.",
  ...
  'admin.github.by': 'ile',
  'admin.github.support': "ODYSSEY'i geliştirmeye devam etmeme yardımcı oluyor",
  'admin.update.available': 'Güncelleme mevcut',
  'admin.update.text': 'ODYSSEY {versiyon} mevcut. {current} çalıştırıyorsunuz.',
  ...
  'admin.update.confirmText':
    'ODYSSEY, {current} sürümünden {version} sürümüne güncellenecek. Sunucu daha sonra otomatik olarak yeniden başlatılacaktır.',
  ...
  'admin.update.dockerText':
    "ODYSSEY örneğiniz Docker'da çalışır. {version} sürümüne güncellemek için sunucunuzda aşağıdaki komutları çalıştırın:",
  ...
  'admin.passkey.rpIdHint':
    'Passkey’lerin bağlı olduğu yalın alan adı, ör. odyssey.example.org. APP_URL’den türetmek için boş bırakın. Daha sonra değiştirmek mevcut passkey’leri geçersiz kılar.',
  'admin.passkey.origins': 'İzin verilen kaynaklar',
  'admin.passkey.originsHint':
    'Virgülle ayrılmış tam kaynaklar, ör. https://odyssey.example.org. APP_URL kullanmak için boş bırakın.',
