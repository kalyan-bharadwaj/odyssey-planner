...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_mcp.body':
    'MCP entegrasyonu tamamen yenilendi. OAuth 2.1 artık önerilen kimlik doğrulama yöntemidir. Eski statik jetonlar (odyssey_…) kullanımdan kaldırıldı ve gelecekteki bir sürümde kaldırılacak.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statik odyssey_ jetonları kullanımdan kaldırıldı',
  ...
  'system_notice.v3_thankyou.body':
    "Before you go — I want to take a moment.\n\nODYSSEY started as a side project I built for my own trips. I never imagined it would grow into something that 4,000 of you now trust to plan your adventures. Every star, every issue, every feature request — I read them all, and they keep me going through late nights between a full-time job and university.\n\nI want you to know: ODYSSEY will always be open source, always self-hosted, always yours. No tracking, no subscriptions, no strings attached. Just a tool built by someone who loves traveling as much as you do.\n\nSpecial thanks to [jubnl](https://github.com/jubnl) — you have become an incredible collaborator. So much of what makes 3.0 great carries your fingerprints. Thank you for believing in this project when it was still rough around the edges.\n\nAnd to every single one of you who filed a bug, translated a string, shared ODYSSEY with a friend, or simply used it to plan a trip — **thank you**. You are the reason this exists.\n\nHere's to many more adventures together.\n\n— Maurice\n\n---\n\n[Join the community on Discord](https://discord.gg/7Q6M6jDwzf)\n\nIf ODYSSEY makes your travels better, a [small coffee](https://ko-fi.com/mauriceboe) always keeps the lights on.",
  ...
  'system_notice.welcome_v1.title': "ODYSSEY'e hoş Geldiniz",
  ...
  'system_notice.welcome_v1.hero_alt': 'ODYSSEY planlama arayüzü kaplamalı manzaralı bir seyahat destinasyonu',
