...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Welkom bij ODYSSEY',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met ODYSSEY interface',
  ...
  'system_notice.v3_mcp.body':
    'De MCP-integratie is volledig vernieuwd. OAuth 2.1 is nu de aanbevolen authenticatiemethode. Statische tokens (odyssey_…) zijn verouderd en worden verwijderd in een toekomstige versie.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische odyssey_-tokens verouderd',
