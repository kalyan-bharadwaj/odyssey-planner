...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.trips:share.description': 'Publieke deellinks aanmaken, bijwerken en inodysseyken',
  ...
  'oauth.scope.journey:share.description': 'Publieke deellinks voor reisverslagen aanmaken, bijwerken en inodysseyken',
  'oauth.authorize.authorizing': 'Authorizing…', // en-fallback
  'oauth.authorize.loading': 'Loading…', // en-fallback
  'oauth.authorize.errorTitle': 'Authorization Error', // en-fallback
  'oauth.authorize.loginTitle': 'Sign in to continue', // en-fallback
  'oauth.authorize.loginDescription': '{client} wants access to your ODYSSEY account. Please sign in first.', // en-fallback
  'oauth.authorize.loginButton': 'Sign in to ODYSSEY', // en-fallback
  'oauth.authorize.requestLabel': 'Authorization Request', // en-fallback
  'oauth.authorize.requestDescription': 'This application is requesting access to your ODYSSEY account.', // en-fallback
