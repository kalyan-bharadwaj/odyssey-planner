...
const settings: TranslationStrings = {
  ...
  'settings.oauth.revoke': 'Inodysseyken',
  'settings.oauth.revokeSession': 'Sessie inodysseyken',
  'settings.oauth.revokeSessionMessage': 'Dit odysseyt onmiddellijk de toegang voor deze OAuth-sessie in.',
  ...
  'settings.oauth.modal.machineClientHint':
    "Gebruikt de client_credentials grant — geen redirect-URI's nodig. Het token wordt direct versodysseyt via client_id + client_secret en handelt namens jou binnen de geselecteerde scopes.",
  ...
  'settings.about.supporters.title': 'Reisgezelschap voor ODYSSEY',
  'settings.about.supporters.subtitle':
    'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van ODYSSEY. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat ODYSSEY Open Source blijft.',
  ...
  'settings.about.description':
    "ODYSSEY is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto's en nog veel meer — alles op één plek, op je eigen server.",
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-odyssey-alerts',
  ...
  'settings.airtrail.writeBackHint':
    'Standaard uit: AirTrail is de bron van waarheid en ODYSSEY leest er alleen uit. Schakel in om in ODYSSEY gemaakte wijzigingen terug te sturen naar AirTrail.',
