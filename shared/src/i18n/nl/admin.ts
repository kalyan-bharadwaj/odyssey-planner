...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je ODYSSEY-ervaring aan te passen.',
  ...
  'admin.weather.description':
    'ODYSSEY gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.oauthSessions.revokeTitle': 'Sessie inodysseyken',
  ...
  'admin.github.support': 'Helpt mij ODYSSEY verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',
  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'ODYSSEY {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'ODYSSEY wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText':
    "Je ODYSSEY-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
  ...
  'admin.passkey.rpIdHint':
    'Het kale domein waaraan passkeys zijn gebonden, bijv. odyssey.example.org. Laat leeg om het af te leiden uit APP_URL. Als je dit later wijzigt, worden bestaande passkeys ongeldig.',
  'admin.passkey.origins': 'Toegestane origins',
  'admin.passkey.originsHint':
    "Volledige origins, gescheiden door komma's, bijv. https://odyssey.example.org. Laat leeg om APP_URL te gebruiken.",
