...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si ODYSSEY.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj ODYSSEY',
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description':
    'ODYSSEY používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'ODYSSEY {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText':
    'ODYSSEY bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText':
    'Váš ODYSSEY běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  ...
  'admin.passkey.rpIdHint':
    'Holá doména, ke které jsou přístupové klíče vázány, např. odyssey.example.org. Ponechte prázdné, aby se odvodila z APP_URL. Pozdější změna zneplatní stávající přístupové klíče.',
  'admin.passkey.origins': 'Povolené origins',
  'admin.passkey.originsHint':
    'Úplné origins oddělené čárkou, např. https://odyssey.example.org. Ponechte prázdné pro použití APP_URL.',
