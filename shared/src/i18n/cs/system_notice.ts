...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Vítejte v ODYSSEY',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním ODYSSEY',
  ...
  'system_notice.v3_mcp.body':
    'Integrace MCP byla kompletně přepracována. OAuth 2.1 je nyní doporučenou metodou ověřování. Statické tokeny (odyssey_…) jsou zastaralé a budou v budoucí verzi odstraněny.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statické tokeny odyssey_ zastaralé',
