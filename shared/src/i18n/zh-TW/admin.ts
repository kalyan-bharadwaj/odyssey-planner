...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '啟用或停用功能以自定義你的 ODYSSEY 體驗。',
  ...
  'admin.weather.description':
    'ODYSSEY 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.github.support': '幫助我繼續開發 ODYSSEY',
  'admin.github.error': '載入版本失敗',
  'admin.github.by': '作者',
  'admin.update.available': '有可用更新',
  'admin.update.text': 'ODYSSEY {version} 已釋出。你當前使用的是 {current}。',
  'admin.update.button': '在 GitHub 檢視',
  'admin.update.install': '安裝更新',
  'admin.update.confirmTitle': '確定安裝更新？',
  'admin.update.confirmText': 'ODYSSEY 將從 {current} 更新到 {version}。伺服器將自動重啟。',
  ...
  'admin.update.dockerText': '你的 ODYSSEY 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：',
  ...
  'admin.passkey.rpIdHint':
    'Passkey 綁定的純網域，例如 odyssey.example.org。留空則從 APP_URL 推導。日後變更將使現有 Passkey 失效。',
  'admin.passkey.origins': '允許的來源',
  'admin.passkey.originsHint': '以逗號分隔的完整來源，例如 https://odyssey.example.org。留空則使用 APP_URL。',
