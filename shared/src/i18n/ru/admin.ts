...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки ODYSSEY под себя.',
  ...
  'admin.weather.description':
    'ODYSSEY использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку ODYSSEY',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',
  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия ODYSSEY {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'ODYSSEY будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText':
    'Ваш экземпляр ODYSSEY работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  ...
  'admin.passkey.rpIdHint':
    'Голый домен, к которому привязаны passkeys, напр. odyssey.example.org. Оставьте пустым, чтобы определить его из APP_URL. Последующее изменение делает существующие passkeys недействительными.',
  'admin.passkey.origins': 'Разрешённые источники',
  'admin.passkey.originsHint':
    'Полные источники через запятую, напр. https://odyssey.example.org. Оставьте пустым, чтобы использовать APP_URL.',
