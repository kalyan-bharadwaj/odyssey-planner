...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями ODYSSEY',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя ODYSSEY',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя ODYSSEY для совместного календаря отпусков.',
