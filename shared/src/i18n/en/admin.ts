...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your ODYSSEY experience.',
  ...
  'admin.weather.description':
    'ODYSSEY uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building ODYSSEY',
  'admin.update.available': 'Update available',
  'admin.update.text': 'ODYSSEY {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText':
    'ODYSSEY will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText':
    'Your ODYSSEY instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'admin.passkey.rpIdHint':
    'The bare domain passkeys are bound to, e.g. odyssey.example.org. Leave empty to derive it from APP_URL. Changing it later invalidates existing passkeys.',
  'admin.passkey.origins': 'Allowed origins',
  'admin.passkey.originsHint':
    'Comma-separated full origins, e.g. https://odyssey.example.org. Leave empty to use APP_URL.',
