...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Travel companions for ODYSSEY',
  ...
  'settings.about.description':
    'ODYSSEY is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  ...
  'settings.airtrail.writeBackHint':
    'Off by default: AirTrail is the source of truth and ODYSSEY only reads from it. Turn on to push edits made in ODYSSEY back to AirTrail.',
