...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_mcp.body':
    'The MCP integration has been fully overhauled. OAuth 2.1 is now the recommended auth method. Legacy static tokens (odyssey_…) are deprecated and will be removed in a future release.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Static odyssey_ tokens deprecated',
  ...
  'system_notice.welcome_v1.title': 'Welcome to ODYSSEY',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with ODYSSEY planning UI overlay',
