...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 ODYSSEY 体验。',
  ...
  'admin.weather.description': 'ODYSSEY 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.github.support': '帮助我继续开发 ODYSSEY',
  'admin.github.error': '加载版本失败',
  'admin.github.by': '作者',
  'admin.update.available': '有可用更新',
  'admin.update.text': 'ODYSSEY {version} 已发布。你当前使用的是 {current}。',
  'admin.update.button': '在 GitHub 查看',
  'admin.update.install': '安装更新',
  'admin.update.confirmTitle': '确定安装更新？',
  'admin.update.confirmText': 'ODYSSEY 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'admin.update.dockerText': '你的 ODYSSEY 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  ...
  'admin.passkey.rpIdHint':
    '通行密钥所绑定的纯域名，如 odyssey.example.org。留空则从 APP_URL 推导。之后更改将使现有通行密钥失效。',
  'admin.passkey.origins': '允许的来源',
  'admin.passkey.originsHint': '以逗号分隔的完整来源，如 https://odyssey.example.org。留空则使用 APP_URL。',
