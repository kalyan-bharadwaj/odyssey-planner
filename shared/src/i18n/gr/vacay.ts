...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Μοιραστείτε το πλάνο διακοπών σας με άλλους χρήστες ODYSSEY',
  'vacay.owner': 'Κάτοχος',
  'vacay.shareEmailPlaceholder': 'Email χρήστη ODYSSEY',
  ...
  'vacay.inviteHint': 'Προσκαλέστε έναν άλλο χρήστη ODYSSEY για να μοιραστείτε ένα κοινό ημερολόγιο διακοπών.',
