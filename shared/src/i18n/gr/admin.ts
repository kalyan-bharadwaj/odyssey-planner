...
const admin: TranslationStrings = {
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'odyssey-admin-alerts',
  ...
  'admin.addons.subtitle':
    'Ενεργοποιήστε ή απενεργοποιήστε λειτουργίες για να εξατομικεύσετε την εμπειρία σας στο ODYSSEY.',
  ...
  'admin.weather.description':
    'Το ODYSSEY χρησιμοποιεί το Open-Meteo ως πηγή δεδομένων καιρού. Το Open-Meteo είναι μια δωρεάν, ανοιχτού κώδικα υπηρεσία καιρού — δεν απαιτείται κλειδί API.',
  ...
  'admin.github.by': 'από',
  'admin.github.support': 'Βοηθά να συνεχίσω την ανάπτυξη του ODYSSEY',
  'admin.update.available': 'Διαθέσιμη ενημέρωση',
  'admin.update.text': 'Το ODYSSEY {version} είναι διαθέσιμο. Εκτελείτε το {current}.',
  ...
  'admin.update.confirmText':
    'Το ODYSSEY θα ενημερωθεί από {current} σε {version}. Ο server θα επανεκκινήσει αυτόματα στη συνέχεια.',
  ...
  'admin.update.dockerText':
    'Η εγκατάστασή σας ODYSSEY εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε τις ακόλουθες εντολές στον server σας:',
  ...
  'admin.passkey.rpIdHint':
    'Ο σκέτος τομέας στον οποίο δεσμεύονται τα passkeys, π.χ. odyssey.example.org. Αφήστε το κενό για να παραχθεί από το APP_URL. Η μεταγενέστερη αλλαγή του ακυρώνει τα υπάρχοντα passkeys.',
  'admin.passkey.origins': 'Επιτρεπόμενες προελεύσεις',
  'admin.passkey.originsHint':
    'Πλήρεις προελεύσεις χωρισμένες με κόμμα, π.χ. https://odyssey.example.org. Αφήστε το κενό για χρήση του APP_URL.',
