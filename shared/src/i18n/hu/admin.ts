...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a ODYSSEY testreszabásához.',
  ...
  'admin.weather.description':
    'A ODYSSEY az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.github.support': 'Segít fenntartani a ODYSSEY fejlesztését',
  'admin.update.available': 'Frissítés elérhető',
  'admin.update.text': 'A ODYSSEY {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText':
    'A ODYSSEY frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText':
    'A ODYSSEY példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  ...
  'admin.passkey.rpIdHint':
    'A csupasz domain, amelyhez a passkey-k kötődnek, pl. odyssey.example.org. Hagyd üresen, hogy az APP_URL-ből legyen levezetve. Későbbi módosítása érvényteleníti a meglévő passkey-ket.',
  'admin.passkey.origins': 'Engedélyezett origók',
  'admin.passkey.originsHint':
    'Vesszővel elválasztott teljes origók, pl. https://odyssey.example.org. Hagyd üresen az APP_URL használatához.',
