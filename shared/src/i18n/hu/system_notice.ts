...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Üdvözöl a ODYSSEY',
  ...
  'system_notice.welcome_v1.hero_alt': 'Festői úticél ODYSSEY tervező felülettel',
  ...
  'system_notice.v3_mcp.body':
    'Az MCP integráció teljesen megújult. Az OAuth 2.1 mostantól az ajánlott hitelesítési módszer. A statikus tokenek (odyssey_…) elavultak és egy jövőbeli kiadásban eltávolításra kerülnek.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statikus odyssey_ tokenek elavultak',
  ...
  'system_notice.v3_thankyou.body':
    'Mielőtt továbbmennél — szeretnék egy pillanatra megállni.\n\nA ODYSSEY egy hobbiprojektként indult, amit a saját utazásaimhoz építettem. Sosem gondoltam volna, hogy valami olyanná nő, amire 4000-en bízzátok a kalandjaitok tervezését. Minden csillagot, minden issue-t, minden funkciókérést — mindet elolvasom, és ezek tartanak életben a késő éjszakákon a teljes állás és az egyetem között.\n\nSzeretnétek, ha tudnátok: a ODYSSEY mindig nyílt forráskódú marad, mindig self-hosted, mindig a tiétek. Nincs nyomkövetés, nincs előfizetés, nincsenek rejtett feltételek. Csak egy eszköz, amit valaki épített, aki ugyanúgy szereti az utazást, mint ti.\n\nKülönleges köszönet [jubnl](https://github.com/jubnl)-nek — hihetetlen társsá váltál. A 3.0 nagyszerűségének nagy része a te kézjegyedet viseli. Köszönöm, hogy hittél ebben a projektben, amikor még nyers volt.\n\nÉs mindannyiótoknak, akik hibát jelentettetek, szöveget fordítottatok, megosztottátok a ODYSSEY-et egy baráttal, vagy egyszerűen csak egy utazást terveztetek vele — **köszönöm**. Ti vagytok az ok, amiért ez létezik.\n\nSok további közös kalandért.\n\n— Maurice\n\n---\n\n[Csatlakozz a közösséghez a Discordon](https://discord.gg/7Q6M6jDwzf)\n\nHa a ODYSSEY jobbá teszi az utazásaidat, egy [kis kávé](https://ko-fi.com/mauriceboe) mindig segít, hogy égve maradjanak a fények.',
