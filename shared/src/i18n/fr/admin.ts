...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience ODYSSEY.',
  ...
  'admin.weather.description':
    'ODYSSEY utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de ODYSSEY',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',
  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'ODYSSEY {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText':
    'ODYSSEY sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText':
    'Votre instance ODYSSEY fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  ...
  'admin.passkey.rpIdHint':
    "Le domaine nu auquel les passkeys sont liées, ex. odyssey.example.org. Laissez vide pour le déduire d'APP_URL. Le modifier ultérieurement invalide les passkeys existantes.",
  'admin.passkey.origins': 'Origines autorisées',
  'admin.passkey.originsHint':
    'Origines complètes séparées par des virgules, ex. https://odyssey.example.org. Laissez vide pour utiliser APP_URL.',
