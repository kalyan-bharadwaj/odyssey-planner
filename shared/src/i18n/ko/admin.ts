...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '기능을 활성화 또는 비활성화하여 ODYSSEY 경험을 맞춤 설정하세요.',
  ...
  'admin.weather.description':
    'ODYSSEY은 날씨 데이터 소스로 Open-Meteo를 사용합니다. Open-Meteo는 무료 오픈 소스 날씨 서비스로 API 키가 필요 없습니다.',
  ...
  'admin.github.by': '작성자',
  'admin.github.support': 'ODYSSEY 개발 지속에 도움이 됩니다',
  'admin.update.available': '업데이트 사용 가능',
  'admin.update.text': 'ODYSSEY {version}이(가) 사용 가능합니다. 현재 {current}을(를) 실행 중입니다.',
  'admin.update.button': 'GitHub에서 보기',
  'admin.update.install': '업데이트 설치',
  'admin.update.confirmTitle': '업데이트를 설치할까요?',
  'admin.update.confirmText': 'ODYSSEY이 {current}에서 {version}으로 업데이트됩니다. 서버가 이후 자동으로 재시작됩니다.',
  ...
  'admin.update.dockerText':
    'ODYSSEY 인스턴스가 Docker에서 실행 중입니다. {version}으로 업데이트하려면 서버에서 다음 명령을 실행하세요:',
  ...
  'admin.passkey.rpIdHint':
    '패스키가 바인딩되는 순수 도메인입니다. 예: odyssey.example.org. 비워두면 APP_URL에서 자동으로 가져옵니다. 나중에 변경하면 기존 패스키가 무효화됩니다.',
  'admin.passkey.origins': '허용된 오리진',
  'admin.passkey.originsHint':
    '쉼표로 구분된 전체 오리진입니다. 예: https://odyssey.example.org. 비워두면 APP_URL을 사용합니다.',
