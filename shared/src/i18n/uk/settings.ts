...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Поки ти плануєш наступний маршрут, ці люди разом зі мною планують майбутнє ODYSSEY. Їхній щомісячний внесок йде безпосередньо в розробку та реальні витрачені години — щоб ODYSSEY залишався Open Source.',
  ...
  'settings.about.description':
    'ODYSSEY — це self-hosted планувальник подорожей, який допомагає організувати поїздки від першої ідеї до останнього спогаду. Планування по днях, бюджет, списки речей, фото та багато іншого — все в одному місці, на вашому власному сервері.',
  ...
  'settings.airtrail.writeBackHint':
    'Типово вимкнено: AirTrail є джерелом істини, а ODYSSEY лише читає з нього. Увімкніть, щоб надсилати зміни, зроблені в ODYSSEY, назад до AirTrail.',
