...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами ODYSSEY',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача ODYSSEY',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача ODYSSEY для спільного календаря відпусток.',
