...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Увімкніть або вимкніть функції, щоб налаштувати ODYSSEY під себе.',
  ...
  'admin.weather.description':
    'ODYSSEY використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.github.support': 'Допомагає продовжувати розробку ODYSSEY',
  'admin.github.error': 'Не вдалося завантажити релізи',
  'admin.github.by': 'від',
  'admin.update.available': 'Доступне оновлення',
  'admin.update.text': 'Доступна версія ODYSSEY {version}. У вас встановлено {current}.',
  ...
  'admin.update.confirmText': 'ODYSSEY буде оновлено з {current} до {version}. Сервер перезапуститься автоматично.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр ODYSSEY працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  ...
  'admin.passkey.rpIdHint':
    'Чистий домен, до якого прив’язані passkeys, напр. odyssey.example.org. Залиште порожнім, щоб визначити його з APP_URL. Подальша зміна робить наявні passkeys недійсними.',
  'admin.passkey.origins': 'Дозволені джерела (origins)',
  'admin.passkey.originsHint':
    'Повні джерела через кому, напр. https://odyssey.example.org. Залиште порожнім, щоб використати APP_URL.',
