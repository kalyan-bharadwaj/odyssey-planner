...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti ODYSSEY',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente ODYSSEY",
  ...
  'vacay.inviteHint': 'Invita un altro utente ODYSSEY a condividere un calendario ferie combinato.',
