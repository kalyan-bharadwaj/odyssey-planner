...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza ODYSSEY.',
  ...
  'admin.weather.description':
    'ODYSSEY utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare ODYSSEY',
  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'ODYSSEY {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText':
    'ODYSSEY verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText':
    'La tua istanza ODYSSEY è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'admin.passkey.rpIdHint':
    'Il dominio puro a cui le passkey sono associate, es. odyssey.example.org. Lascia vuoto per derivarlo da APP_URL. Modificarlo in seguito invalida le passkey esistenti.',
  'admin.passkey.origins': 'Origini consentite',
  'admin.passkey.originsHint':
    'Origini complete separate da virgola, es. https://odyssey.example.org. Lascia vuoto per usare APP_URL.',
