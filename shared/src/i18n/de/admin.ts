...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um ODYSSEY nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description':
    'ODYSSEY nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, ODYSSEY weiterzuentwickeln',
  'admin.update.available': 'Update verfügbar',
  'admin.update.text': 'ODYSSEY {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText':
    'ODYSSEY wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText':
    'Deine ODYSSEY-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  ...
  'admin.passkey.rpIdHint':
    'Die reine Domain, an die Passkeys gebunden sind, z. B. odyssey.example.org. Leer lassen, um sie aus APP_URL abzuleiten. Eine spätere Änderung macht bestehende Passkeys ungültig.',
  'admin.passkey.origins': 'Erlaubte Origins',
  'admin.passkey.originsHint':
    'Vollständige Origins, durch Komma getrennt, z. B. https://odyssey.example.org. Leer lassen, um APP_URL zu verwenden.',
