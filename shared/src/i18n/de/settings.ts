...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Reisebegleitung für ODYSSEY',
  'settings.about.supporters.subtitle':
    'Während du deine nächste Route planst, planen diese Leute mit, wie ODYSSEY weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit ODYSSEY Open Source bleibt.',
  ...
  'settings.about.description':
    'ODYSSEY ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  ...
  'settings.airtrail.writeBackHint':
    'Standardmäßig aus: AirTrail ist die maßgebliche Quelle und ODYSSEY liest nur. Aktivieren, um in ODYSSEY vorgenommene Änderungen zurück an AirTrail zu senden.',
