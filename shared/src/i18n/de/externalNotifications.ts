...
const de: NotificationLocale = {
  email: {
    footer: 'Du erhältst diese E-Mail, weil du Benachrichtigungen in ODYSSEY aktiviert hast.',
    manage: 'Einstellungen verwalten',
    madeWith: 'Made with',
    openOdyssey: 'ODYSSEY öffnen',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} hat dich eingeladen, Urlaubspläne zu fusionieren. Öffne ODYSSEY um anzunehmen oder abzulehnen.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Neue ODYSSEY-Version verfügbar',
      body: `ODYSSEY ${p.version} ist jetzt verfügbar. Besuche das Admin-Panel zum Aktualisieren.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Hallo',
    body: 'Wir haben eine Anfrage erhalten, das Passwort für dein ODYSSEY-Konto zurückzusetzen. Klicke auf den Button unten, um ein neues Passwort festzulegen.',
