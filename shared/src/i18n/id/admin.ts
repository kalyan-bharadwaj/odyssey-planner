...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Aktifkan atau nonaktifkan fitur untuk menyesuaikan pengalaman ODYSSEY kamu.',
  ...
  'admin.weather.description':
    'ODYSSEY menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.',
  ...
  'admin.github.support': 'Bantu saya terus mengembangkan ODYSSEY',
  'admin.update.available': 'Pembaruan tersedia',
  'admin.update.text': 'ODYSSEY {version} tersedia. Kamu menggunakan {current}.',
  'admin.update.button': 'Lihat di GitHub',
  'admin.update.install': 'Pasang Pembaruan',
  'admin.update.confirmTitle': 'Pasang Pembaruan?',
  'admin.update.confirmText':
    'ODYSSEY akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.',
  ...
  'admin.update.dockerText':
    'Instans ODYSSEY kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:',
  ...
  'admin.passkey.rpIdHint':
    'Domain murni tempat passkey diikat, mis. odyssey.example.org. Kosongkan untuk mengambilnya dari APP_URL. Mengubahnya nanti akan membatalkan passkey yang sudah ada.',
  'admin.passkey.origins': 'Origin yang diizinkan',
  'admin.passkey.originsHint':
    'Origin lengkap dipisahkan koma, mis. https://odyssey.example.org. Kosongkan untuk menggunakan APP_URL.',
