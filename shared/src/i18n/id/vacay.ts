...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Bagikan rencana cuti kamu dengan pengguna ODYSSEY lainnya',
  'vacay.owner': 'Pemilik',
  'vacay.shareEmailPlaceholder': 'Email pengguna ODYSSEY',
  ...
  'vacay.inviteHint': 'Undang pengguna ODYSSEY lain untuk berbagi kalender cuti bersama.',
