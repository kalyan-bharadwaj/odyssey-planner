...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة ODYSSEY.',
  ...
  'admin.weather.description':
    'يستخدم ODYSSEY خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير ODYSSEY',
  'admin.update.available': 'يتوفر تحديث',
  'admin.update.text': 'ODYSSEY {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث ODYSSEY من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل ODYSSEY الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'odyssey-admin-alerts', // en-fallback
  ...
  'admin.passkey.rpIdHint':
    'النطاق المجرّد الذي تُربط به مفاتيح المرور، مثل odyssey.example.org. اتركه فارغًا لاشتقاقه من APP_URL. تغييره لاحقًا يُبطل مفاتيح المرور الموجودة.',
  'admin.passkey.origins': 'الأصول المسموح بها',
  'admin.passkey.originsHint': 'أصول كاملة مفصولة بفواصل، مثل https://odyssey.example.org. اتركه فارغًا لاستخدام APP_URL.',
