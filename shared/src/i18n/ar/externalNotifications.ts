...
const ar: NotificationLocale = {
  email: {
    footer: 'تلقيت هذا لأنك قمت بتفعيل الإشعارات في ODYSSEY.',
    manage: 'إدارة التفضيلات',
    madeWith: 'Made with',
    openOdyssey: 'فتح ODYSSEY',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} يدعوك لدمج خطط الإجازة. افتح ODYSSEY للقبول أو الرفض.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'إصدار ODYSSEY جديد متاح',
      body: `ODYSSEY ${p.version} متاح الآن. تفضل بزيارة لوحة الإدارة للتحديث.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'مرحبا',
    body: 'تلقينا طلبًا لإعادة تعيين كلمة المرور لحسابك في ODYSSEY. انقر على الزر أدناه لتعيين كلمة مرور جديدة.',
