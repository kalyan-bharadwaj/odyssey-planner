...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'رفاق رحلة ODYSSEY',
  'settings.about.supporters.subtitle':
    'بينما تخطّط لمسارك التالي، يساعد هؤلاء الأشخاص في التخطيط لمستقبل ODYSSEY. تذهب مساهمتهم الشهرية مباشرةً إلى التطوير والساعات الفعلية المبذولة — حتى يظلّ ODYSSEY مفتوح المصدر.',
  'settings.about.supporters.since': 'داعم منذ {date}',
  'settings.about.supporters.tierEmpty': 'كن الأول',
  'settings.about.description':
    'ODYSSEY هو مخطط سفر مستضاف ذاتيًا يساعدك على تنظيم رحلاتك من أول فكرة حتى آخر ذكرى. تخطيط يومي، ميزانية، قوائم تعبئة، صور والمزيد — كل شيء في مكان واحد، على خادمك الخاص.',
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-odyssey-alerts', // en-fallback
  ...
  'settings.airtrail.writeBackHint':
    'مُعطّل افتراضيًا: AirTrail هو مصدر الحقيقة وODYSSEY يقرأ منه فقط. فعّله لإرسال التعديلات التي تجريها في ODYSSEY إلى AirTrail.',
