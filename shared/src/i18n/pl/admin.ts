...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w ODYSSEY.',
  ...
  'admin.weather.description':
    'ODYSSEY korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.github.support': 'Pomóż mi rozwijać ODYSSEY',
  'admin.update.available': 'Dostępna aktualizacja',
  'admin.update.text': 'Dostępna jest wersja ODYSSEY {version}. Używasz {current}.',
  ...
  'admin.update.confirmText':
    'ODYSSEY zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText':
    'Twoja instancja ODYSSEY działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  ...
  'admin.passkey.rpIdHint':
    'Sama domena, do której przypisane są klucze dostępu, np. odyssey.example.org. Pozostaw puste, aby wyprowadzić ją z APP_URL. Późniejsza zmiana unieważnia istniejące klucze dostępu.',
  'admin.passkey.origins': 'Dozwolone origins',
  'admin.passkey.originsHint':
    'Pełne origins oddzielone przecinkami, np. https://odyssey.example.org. Pozostaw puste, aby użyć APP_URL.',
