...
This is the ODYSSEY project's policy for the use of our trademarks. While ODYSSEY is
...
be full participants in the ODYSSEY project.

## Our trademarks

This policy covers the name "ODYSSEY" as well as any associated logos, trade dress,
...
say you are distributing ODYSSEY when you're distributing a modified version of it,
...
your website in a way that suggests that your website is an official ODYSSEY
website or that we endorse your website. But, if true, you can say you like
ODYSSEY, that you participate in the ODYSSEY community, that you are providing an
unmodified version of ODYSSEY, or that you wrote a guide describing how to use
ODYSSEY.
...
When you redistribute an unmodified copy of ODYSSEY, you are not changing the
...
you are redistributing an official ODYSSEY distribution that has not been changed
in any way.

## Distribution of executable code that you have compiled, or modified code

You may use the word mark "ODYSSEY", but not any ODYSSEY logos, to truthfully
describe the origin of the software that you are providing, that is, that the
code you are distributing is a modification of ODYSSEY. You may say, for example,
that "this software is derived from the source code for ODYSSEY."
...
executable) on the condition that any executable is built from an official ODYSSEY
...
The following clarifications apply specifically to common ways ODYSSEY is
redistributed:

* **Self-hosted instances of unmodified ODYSSEY.** You may refer to your instance
  as "a ODYSSEY instance" or "running ODYSSEY." You may not name the service itself
  in a way that suggests it is the official ODYSSEY ("ODYSSEY Cloud," "ODYSSEY
  Official," etc.).
* **Mobile wrappers (WebView shells, Capacitor apps, native apps) pointing at
  ODYSSEY.** You may describe your app as "a mobile client for ODYSSEY" or "for use
  with ODYSSEY." You may not publish it on app stores under the name "ODYSSEY" or a
  confusingly similar name, and you may not use the ODYSSEY logo as the app icon
  unless your wrapper distributes only an unmodified, official ODYSSEY instance
  and you have obtained permission.
* **Forks of the ODYSSEY source code.** Forks that diverge from upstream must use
  a different name. You may state that your fork is "based on ODYSSEY" or "a fork
  of ODYSSEY," but the project name itself must be your own.

## Statements about your software's relation to ODYSSEY

You may use the word mark, but not ODYSSEY logos, to truthfully describe the
relationship between your software and ours. The word mark "ODYSSEY" should be
used after a verb or preposition that describes the relationship between your
software and ours. So you may say, for example, "Bob's app for ODYSSEY" but may
not say "Bob's ODYSSEY app." Some other examples that may work for you are:

* [Your software] uses ODYSSEY
* [Your software] is powered by ODYSSEY
* [Your software] runs on ODYSSEY
* [Your software] for use with ODYSSEY
* [Your software] for ODYSSEY
...
is not covered, please open an issue on the ODYSSEY GitHub repository or contact
