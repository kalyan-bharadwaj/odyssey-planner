...
The Settings page lets you personalise every aspect of ODYSSEY — appearance, maps, notifications, offline behaviour, and your account.
...
If your account requires MFA setup, ODYSSEY redirects you directly to the **Account** tab (via `?mfa=required`).
