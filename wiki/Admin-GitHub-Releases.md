...
The **GitHub** tab shows the ODYSSEY release history fetched from GitHub and provides links to community resources and support options.
...
| **Discord** | Join the ODYSSEY community |
...
Below the support cards, a chronological timeline lists GitHub releases for the `mauriceboe/ODYSSEY` repository. Each entry shows:
