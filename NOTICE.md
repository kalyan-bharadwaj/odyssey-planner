...
ODYSSEY bundles and uses third-party data that requires attribution.
...
property names ODYSSEY consumes. Country borders (`admin0`) derive from the geoBoundaries
